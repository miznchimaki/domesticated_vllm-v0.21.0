...
_TOKEN_CLASSIFICATION_EXAMPLE_MODELS = {
    ...
    "dummy_api_key_redacted_for_git": _HfExamplesInfo(
...
_AUTOMATIC_CONVERTED_MODELS = {
    ...
    "dummy_api_key_redacted_for_git": _HfExamplesInfo(
        ...
        is_available_online=False,
        hf_overrides={
            "architectures": ["dummy_api_key_redacted_for_git"],
...
_MULTIMODAL_EXAMPLE_MODELS = {
    ...
    "dummy_api_key_redacted_for_git": _HfExamplesInfo("zai-org/GLM-4.5V"),
    ...
    "dummy_api_key_redacted_for_git": _HfExamplesInfo("OpenGVLab/InternVL3-1B-hf"),
