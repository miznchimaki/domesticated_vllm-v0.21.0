...
!!! note
    ...
    ```bash
    vllm serve Qwen/Qwen3-VL-Reranker-2B --hf_overrides '{"architectures": ["dummy_api_key_redacted_for_git"],"classifier_from_token": ["no", "yes"],"is_original_qwen3_reranker": true}'
    ```
