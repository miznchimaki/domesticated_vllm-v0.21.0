...
if TYPE_CHECKING:
    ...
    VLLM_ENABLE_DATA_PARALLEL_SERVING_METRICS: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to enable serving metrics when using data parallel
    # The metrics is incorrect when using data parallel and it is disable by default
    # See: https://github.com/vllm-project/vllm/issues/21954
    "VLLM_ENABLE_DATA_PARALLEL_SERVING_METRICS": lambda: bool(
        int(os.getenv("VLLM_ENABLE_DATA_PARALLEL_SERVING_METRICS", "0"))
    ),
}
...
def compile_factors() -> dict[str, object]:
    ...
    ignored_factors: set[str] = {
        ...
        "NO_COLOR",
        "VLLM_ENABLE_DATA_PARALLEL_SERVING_METRICS",
    }
