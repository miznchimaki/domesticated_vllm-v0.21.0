...
_TEXT_GENERATION_MODELS = {
    # GRM_QWEN35_TEXT_REGISTRY_PATCH_V1
...
_SEQUENCE_CLASSIFICATION_MODELS = {
    ...
    "dummy_api_key_redacted_for_git": ("roberta", "dummy_api_key_redacted_for_git"),
...
_MULTIMODAL_MODELS = {
    ...
    "dummy_api_key_redacted_for_git": ("glm4_1v", "dummy_api_key_redacted_for_git"),
