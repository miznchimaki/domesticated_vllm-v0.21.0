...
def get_tokenizer(
    ...
    **kwargs,
    ...
    # TODO(hmellor): This is a temporary fix. The long-term solution is to
    # ensure that get_cached_tokenizer is called for all tokenizers, or that
    # max_token_id is added to the TokenizersBackend class in transformers.
    # See: https://github.com/vllm-project/vllm/pull/30566
    # See: https://github.com/huggingface/transformers/pull/45449
    if model_type in _MODEL_TYPES_WITH_INCORRECT_TOKENIZER_CLASS:
